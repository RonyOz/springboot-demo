...
import com.example.springboot_demo.service.impl.CourseServiceImpl;
...
public class CourseServiceTest {
    ...
    // Inyectamos el mock a CourseService teniendo en cuenta la dependencia que
    // tiene
    @InjectMocks
    ...
    void getAllCourses_WhenCalled_ReturnsCourseList() {
        // Arrange
        // Creamos la información que simularemos que nos devolverá la capa de
        // Repository
        ...
        // La estructura es when( llamado a repository ) -> thenReturn( se devuelve la
